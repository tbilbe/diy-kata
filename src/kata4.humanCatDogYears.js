const humanCatDogYears = (number) => {
    ...
    if (number < 0){return "Positive numbers only you cheeky beggar!"}
    if(numberRounded===0){return [0,0,0]}
    if (numberRounded===1){return [1,15,15]}
    if (numberRounded===2){return [2,24,24]}
    if (numberRounded>=3){   
